...
<body>
    ...
    <div class="right-content">
        ...
        <form id="updateForm" class="container mb-3" action="dao/aluno_confirmar_alteracoes.php" method="POST"
            enctype="multipart/form-data">
            <p>* É possível alterar as informações. Para fazer isso, altere o que for necessário, clique em salvar e
                confirme.</p>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="cpf" name="Cpf" value="<?php echo $alunoCpf; ?>" readonly
                    required>
            </div>
            <div class="mb-3">
                <label for="ra" class="form-label">RA:</label>
                <input type="number" class="form-control" id="ra" name="Ra" value="<?php echo $alunoRa; ?>" required>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email:</label>
                <input type="text" class="form-control" id="email" name="Email" value="<?php echo $alunoEmail; ?>"
                    required>
            </div>
            <div class="mb-3">
                <label for="celular" class="form-label">Celular:</label>
                <input type="text" class="form-control" id="celular" name="Celular" value="<?php echo $alunoCelular; ?>"
                    required>
            </div>
            <div class="mb-3">
                <label for="turno" class="form-label">Turno:</label>
                <select class="form-select" name="Turno" id="turno" aria-label="Default select example">
                    <option selected value="<?php echo $alunoTurno ?>" style="color: darkgray;">
                        <?php echo $alunoTurno; ?> // atual
                    </option>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="Curso" id="curso" value="<?php echo $alunoCurso ?>"
            ...
            <div>
                <button type="button" class="btn btn-primary" id="button-adicionar" data-bs-toggle="modal"
                    data-bs-target="#modal-confirmar">Salvar</button>
                <button type="button" class="btn btn-secondary" id="button-adicionar" data-bs-toggle="modal"
                    data-bs-target="#modal-alterar-senha">Alterar Senha</button>

                <!-- modal de confimar alterações -->
                <div class="modal fade" id="modal-confirmar" data-bs-keyboard="false" tabindex="-1"
                    aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="staticBackdropLabel">Tem certeza de que deseja salvar
                                    as alterações?</h1>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="confirmar-atualizacoes"
        ...
        <form action="dao/aluno_confirmar_alteracoes.php" method="POST">
            <div class="modal fade" id="modal-alterar-senha" data-bs-keyboard="false" tabindex="-1"
                aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="senhaAtual" id="SenhaAtual" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="confirmarNovaSenha"
                                    id="confirmarNovaSenha" required>
                            </div>
                        </div>
                        <div class="modal-footer">
