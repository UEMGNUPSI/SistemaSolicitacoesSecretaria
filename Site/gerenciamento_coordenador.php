                ...
                <form class="form-horizontal" action="gerenciamento_coordenador.php" method="get">
                    <div class="row">
                        <div class="col">
                            ...
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modal-adicionar" title="Adicionar coordenador" >Adicionar coordenador<i class="fa-solid fa-graduation-cap" style="margin-left: 5px;"></i></button>
                        </div>
                        <div class="col">
                            <div class="controls">
                ...
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped " >
                            <thead>
                                ...
                                <th scope="col" style="width: 7%;">Nome</th>
                                <th scope="col" style="width: 7%;">CPF</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                            ...
                            <label for="coordenadorNome" class="form-label">Nome:</label>
                            <input type="text" class="form-control" id="coordenadorInputAdicionar" placeholder="Insira aqui" maxlength="30" name="coordenadorNome" required>
                    </div>
                    <div class= "mb-3">
                            <label for="coordenadorCpf" class="form-label">CPF:</label>
                            <input type="number" class="form-control" placeholder="Insira aqui" maxnumber="11" name="coordenadorCpf" maxlength="2" required> 
                    </div>
                    </div>
                    <div class="form-input">
                        <div class= "mb-3">
