...
<body>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <button type="button" class="btn btn-success" data-bs-toggle="modal"
                            data-bs-target="#adicionar-tpu" title="adicionar-tpu">Adicionar Tipo Usuario<i
                    ...
                    <div class="col">
                        <button type="submit" class="btn btn-primary" title="Filtrar"><i
                ...
                <div class="modal-body">
                    <form id="updateForm" action="dao/tipo_usuario.php" method="POST">
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="atualizar-tpu" class="btn btn-primary"
    ...
    <div class="modal fade" id="adicionar-tpu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="updateForm" action="dao/tipo_usuario.php" method="POST">
                        <div class="mb-3">
                            <label for="idtpu" class="form-label">Nome do Tipo de Usuário:</label>
                            <input type="text" class="form-control" id="input-adicionar" placeholder="Insira aqui"
                                minlength="4" maxlength="13" name="idtpu">
                        </div>
                        <div class="modal-footer">
                            <button type="submit" name="adicionar-tpu" class="btn btn-primary"
