...
<body>
    ...
    <div class="right-content">
        ...
        <form id="updateForm" class="container" action="dao/solicitacao.php" method="POST">   
        <input type="hidden" id="solId" name="solId">
            ...
            <input type="file" class="form-control" id="solicitacaoInputAdicionar" placeholder="Insira aqui" multiple = "multiple" name="solicitacaoArquivo">
            </div>
    ...
    <script>
        ...
        var texto = document.getElementById("textParagraph");
            ...
            if (selectElement.value == "Prova de segunda oportunidade") {
