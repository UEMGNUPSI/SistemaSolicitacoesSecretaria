...
<body>
    ...
    <div class="right-content">
        ...
        <main class="container">
            ...
            <p>Para solicitações concluídas, a resposta e a justificativa do coordenador são exibidas no topo das
                informações ao clicar em visualizar.</p>
                    ...
                    <form id="updateForm" action="dao/solicitacao.php" method="POST">
                        ...
                        <div class="campos-modal-consulta-solicitacao">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="solicitacaoCurso" id="solicitacaoCurso"
                                    aria-label="Default select example" disabled>
                            </div>

                            <div class="mb-3">
                                <label for="solicitacaoArquivo" class="form-label">Arquivos Comprovantes:</label>
                                <div class="anexos-container"></div>
                                <!-- Este é o contêiner onde os anexos serão exibidos -->
                            </div>
